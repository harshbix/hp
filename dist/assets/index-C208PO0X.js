...
`)+`
`+_);const T=S+p+a,M=S+_+o,A=od(i,i.VERTEX_SHADER,T),w=od(i,i.FRAGMENT_SHADER,M);i.attachShader(g,A),i.attachShader(g,w),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function b(R){if(r.debug.checkShaderErrors){const I=i.getProgramInfoLog(g)||"",z=i.getShaderInfoLog(A)||"",V=i.getShaderInfoLog(w)||"",B=I.trim(),k=z.trim(),N=V.trim();let J=!0,Q=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(J=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,A,w);else{const D=cd(i,A,"vertex"),le=cd(i,w,"fragment");ft("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
Source: Website Booking`,b=`https://wa.me/255628818312?text=${encodeURIComponent(A)}`;setTimeout(()=>{h.classList.remove("is-loading"),h.classList.add("is-success"),m.innerText="Success!",setTimeout(()=>{window.location.href=b,d(r),setTimeout(()=>{a.reset(),h.classList.remove("is-success"),m.innerText=g},800)},600)},1200)})}function XE(){const r=document.createElement("div");r.id="custom-cursor";const e=document.createElement("span");e.className="cursor-text",r.appendChild(e),document.body.appendChild(r);let t=0,n=0,i=0,s=0;window.addEventListener("mousemove",f=>{t=f.clientX,n=f.clientY,i===0&&s===0&&(i=t,s=n,It.set(r,{x:t,y:n,opacity:1}))});function a(){i+=(t-i)*.65,s+=(n-s)*.65,It.set(r,{x:i,y:s}),requestAnimationFrame(a)}requestAnimationFrame(a);function o(){r.classList.contains("hover-active")?e.innerText="":r.classList.contains("hover-view")?e.innerText="Explore":r.classList.contains("hover-water")?e.innerText="+":r.classList.contains("hover-hero")?e.innerText="Drag":e.innerText=""}const l=document.querySelectorAll("a, button, input, select, .magnetic-btn"),c=document.querySelectorAll(".project-card, .archive-btn"),u=document.getElementById("hero"),d=document.getElementById("contact");l.forEach(f=>{f.addEventListener("mouseenter",()=>{r.classList.add("hover-active"),o()}),f.addEventListener("mouseleave",()=>{r.classList.remove("hover-active"),o()})}),c.forEach(f=>{f.addEventListener("mouseenter",()=>{r.classList.add("hover-view"),o()}),f.addEventListener("mouseleave",()=>{r.classList.remove("hover-view"),o()})}),u&&(u.addEventListener("mouseenter",()=>{r.classList.add("hover-hero"),o()}),u.addEventListener("mouseleave",()=>{r.classList.remove("hover-hero"),o()})),d&&(d.addEventListener("mouseenter",()=>{r.classList.add("hover-water"),o()}),d.addEventListener("mouseleave",()=>{r.classList.remove("hover-water"),o()}))}function YE(){const r=document.getElementById("contact");if(!r)return;const e=document.createElement("canvas");e.id="ripple-canvas",e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width="100%",e.style.height="100%",e.style.zIndex="0",e.style.pointerEvents="none",e.style.opacity="0.3",r.style.position="relative",r.style.overflow="hidden",r.insertBefore(e,r.firstChild);const t=e.getContext("2d",{willReadFrequently:!0});let n,i,s,a,o=0,l,c,u=[],d=[],f;const h=3,m=document.createElement("canvas"),g=m.getContext("2d",{willReadFrequently:!0});let p=0,_=0;function S(){const b=Math.floor(r.clientWidth),v=Math.floor(Math.max(r.clientHeight,r.offsetHeight));if(b===0||v===0||b===p&&v===_)return;n=b,i=v,p=n,_=i,e.width=n,e.height=i,e.style.width=n+"px",e.style.height=i+"px",m.width=n,m.height=i,s=n>>1,a=i>>1,o=n*(i+2)*2,u=new Int16Array(o),d=new Int16Array(o),l=d,c=u;const y=g.createRadialGradient(s,a,0,s,a,Math.max(n,i));y.addColorStop(0,"#1a1a1a"),y.addColorStop(1,"#050505"),g.fillStyle=y,g.fillRect(0,0,n,i),g.strokeStyle="rgba(255,255,255,0.08)",g.lineWidth=1;for(let P=0;P<Math.max(n,i);P+=30)g.beginPath(),g.moveTo(P,0),g.lineTo(P,i),g.stroke(),g.beginPath(),g.moveTo(0,P),g.lineTo(n,P),g.stroke();f=g.getImageData(0,0,n,i)}window.addEventListener("resize",()=>{setTimeout(S,100)}),window.ResizeObserver?new ResizeObserver(()=>S()).observe(r):S();let T=!1;const M=b=>{T=!0;const v=r.getBoundingClientRect(),y=b.touches?b.touches[0].clientX:b.clientX,P=b.touches?b.touches[0].clientY:b.clientY,R=Math.floor(y-v.left),I=Math.floor(P-v.top);A(R,I)};r.addEventListener("mousemove",M),r.addEventListener("touchmove",M,{passive:!0}),r.addEventListener("touchstart",M,{passive:!0}),r.addEventListener("mouseleave",()=>T=!1),r.addEventListener("touchend",()=>T=!1);function A(b,v){if(b=Math.floor(b),v=Math.floor(v),!(b<h||b>=n-h||v<h||v>=i-h))for(let y=v-h;y<v+h;y++)for(let P=b-h;P<b+h;P++){const R=y*n+P;R>=0&&R<d.length&&(l[R]+=1024)}}function w(){if(!n||!i)return requestAnimationFrame(w);!T&&Math.random()>.95&&A(Math.random()*n,Math.random()*i);const b=t.getImageData(0,0,n,i),v=b.data,y=f.data;let P=n,R=n*i-n;for(;P<R;P++){c[P]=(l[P-1]+l[P+1]+l[P-n]+l[P+n]>>1)-c[P],c[P]-=c[P]>>5;let V=(c[P]-1024)*.05>>0,B=P%n,k=P/n>>0,N=B+V,J=k+V;N<0?N=0:N>=n&&(N=n-1),J<0?J=0:J>=i&&(J=i-1);let Q=(N+J*n)*4,D=P*4;v[D]=y[Q],v[D+1]=y[Q+1],v[D+2]=y[Q+2],v[D+3]=255}let I=l;l=c,c=I,t.putImageData(b,0,0),requestAnimationFrame(w)}w()}It.registerPlugin(nt);const Ff=new s_({lerp:.1,smoothWheel:!0});function Km(r){Ff.raf(r),requestAnimationFrame(Km)}requestAnimationFrame(Km);Ff.on("scroll",nt.update);It.ticker.add(r=>{Ff.raf(r*1e3)});It.ticker.lagSmoothing(0,0);document.body.classList.add("loading");document.addEventListener("DOMContentLoaded",()=>{tE(),HE(),WE(),XE(),YE();const r=document.getElementById("preloader-counter"),e=document.getElementById("preloader"),t=document.getElementById("app");let n={value:0};It.timeline({onComplete:()=>{document.body.classList.remove("loading"),zE(),e.style.display="none"}}).to(n,{value:100,duration:2,ease:"power2.inOut",onUpdate:()=>{r&&(r.innerText=Math.floor(n.value)+"%")}}).to(".preloader-content",{opacity:0,duration:.5,ease:"power2.inOut"},"+=0.2").to(e,{y:"-100%",duration:1,ease:"power4.inOut"},"-=0.1").to(t,{opacity:1,duration:1},"-=0.8")});console.log("Digital Gallery Architecture Initialized.");
